      ...
      return (
        <div className="w-full h-full flex flex-col items-center justify-center text-emerald-300">
          ...
          <p className="mt-3 text-sm text-gray-400 max-w-md text-center">
            WebGL failed to initialize in this browser. The rest of the page is available, but the 3D schematic is disabled.
          </p>
        </div>
      );
    }
    ...
    <section className="h-screen w-screen relative bg-[#050714] overflow-hidden">
          ...
          <div className="container mx-auto flex justify-between items-start">
             <div className="pointer-events-auto">
                <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tighter">
                    MZ-9000 <span className="text-emerald-400">Schematic</span>
                </h1>
      ...
      {webglAvailable ? (
        ...
        <div className="w-full h-full flex flex-col items-center justify-center text-emerald-300">
          ...
          <p className="mt-3 text-sm text-gray-400 max-w-md text-center">
            This device does not support WebGL. The 3D schematic is disabled, but all other content remains accessible.
          </p>
        </div>
      )}
