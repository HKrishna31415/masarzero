  ...
  return (
    <div className="relative w-full aspect-video bg-[#0B1021] rounded-xl border border-white/10 overflow-hidden select-none shadow-2xl">
        ...
        <div className="absolute left-[5%] top-[60%] w-[60%] h-[30%] flex gap-4 z-0">
            ...
            {/* UST 1 (Farther) */}
            <div className="flex-1 border-2 border-slate-600 bg-[#0c1e1b]/30 rounded-lg relative overflow-hidden flex flex-col justify-end">
                {/* Vapor Space */}
        ...
        {/* --- VRU (Above Ground) --- */}
        <div className="absolute right-[10%] top-[15%] w-[22%] h-[35%] border-2 border-emerald-500/50 bg-[#0f172a] rounded-xl z-20 flex flex-col items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.15)]">
             <div className="w-16 h-16 rounded-full border border-emerald-400/30 flex items-center justify-center relative mb-2">
                <motion.div 
        ...
        <svg className="absolute inset-0 w-full h-full z-10 pointer-events-none overflow-visible" viewBox="0 0 800 450">
            ...
            {/* 1. Vapor Flow: USTs -> VRU (Dotted Teal) */}
            ...
            <motion.path 
                ...
                stroke="#14b8a6" strokeWidth="2" strokeDasharray="6 6" fill="none" strokeOpacity="0.8"
            ...
            <motion.path 
                ...
                stroke="#14b8a6" strokeWidth="2" fill="none" opacity="0.8"
            />


            {/* 2. Cycle Return Loop: VRU -> Both USTs (Dotted Teal, Lighter) */}
            ...
            <motion.path 
                ...
                stroke="#14b8a6" strokeWidth="2" strokeDasharray="4 4" fill="none" strokeOpacity="0.4"
            ...
            {/* 3. Recovered Gasoline: VRU -> UST 2 Only (Solid Emerald) */}
            {/* VRU Bottom X ~630, Y ~225 */}
            {/* UST 2 Liquid Entry X ~480, Y ~350 */}
            
            <motion.path 
                d="M 630 225 L 630 380 L 480 380 L 480 340"
                stroke="#10b981" strokeWidth="3" fill="none" strokeLinecap="round" filter="url(#glow)"
