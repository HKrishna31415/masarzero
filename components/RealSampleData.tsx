    ...
    return (
        ...
        >
            <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-emerald-400">Real Sample Data</h2>
            </div>
            <div className="bg-slate-900/50 border border-slate-700 rounded-xl p-6 shadow-2xl relative overflow-hidden">
                ...
                <div className="w-full text-center my-6">
                    <button className="w-full relative aurora-border font-bold py-3 rounded-lg text-emerald-300 hover:bg-emerald-400/20 transition-all duration-300">
                        View Sample Report
                    </button>
                </div>
                ...
                <div className="border-t border-slate-700 pt-4 grid grid-cols-3 gap-4 text-center">
                    <div>
                        <Droplet className="w-6 h-6 mx-auto text-emerald-400 mb-1" />
                        <span className="text-xs text-slate-400">Octane</span>
                        <p className="font-bold text-lg">90</p>
                    </div>
                     <div>
                        <TestTube className="w-6 h-6 mx-auto text-emerald-400 mb-1" />
                        <span className="text-xs text-slate-400">Ethanol</span>
                        <p className="font-bold text-lg">9.8%</p>
                    </div>
                     <div>
                        <Thermometer className="w-6 h-6 mx-auto text-emerald-400 mb-1" />
